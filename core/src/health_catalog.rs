...
pub const CATALOG: &[CatalogEntry] = &[
    ...
    CatalogEntry {
        ...
        requirement: RequirementLevel::Optional,
        probe: Probe::Local,
        impact: "Tasks using Claude Code cannot start if the default claude program or $RALPHUS_CLAUDE_COMMAND override is unavailable.",
        remediation: "Install claude on PATH, or set $RALPHUS_CLAUDE_COMMAND to a real executable.",
    },
    CatalogEntry {
        id: ID_CODEX_COMMAND,
        label: "codex command",
        ...
        requirement: RequirementLevel::Optional,
        probe: Probe::Local,
        impact: "Tasks using Codex cannot start if the default codex program or $RALPHUS_CODEX_COMMAND override is unavailable.",
        remediation: "Install codex on PATH, or set $RALPHUS_CODEX_COMMAND to a real executable.",
    },
    CatalogEntry {
        id: ID_PI_COMMAND,
        ...
        requirement: RequirementLevel::Optional,
        probe: Probe::Local,
        impact: "Tasks using Pi cannot start if the default pi program or $RALPHUS_PI_COMMAND override is unavailable or older than 0.85.1.",
        remediation: "Install Pi 0.85.1 or later on PATH, or set $RALPHUS_PI_COMMAND to a compatible executable.",
    },
    CatalogEntry {
        id: ID_CONFIG,
