      ...
      function proofView(r) {
        ...
        const terminalBtns = (() => {
          ...
          return `<div class="btn-row" style="position:relative;gap:0">${previewBtn}${terminalMenuHtml(key, items)}</div>${peekBox(key, v.started_at_ms ?? null, null, v.finished_at_ms ?? null)}${historyBox(key)}`;
        })();
