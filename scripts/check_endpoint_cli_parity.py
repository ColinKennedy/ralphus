...
ENDPOINT_TO_CLI: dict[str, list[str]] = {
    ...
    "POST /api/projects/{name}/webhook/install": ["project webhook install"],
    "GET /api/projects/{name}/webhook/status": ["project webhook status"],
    "POST /api/projects/{name}/webhook/uninstall": ["project webhook uninstall"],
    "POST /api/projects/{name}/webhook/update": ["project webhook update"],
    "POST /api/projects/{name}/webhook/check": ["project webhook check"],
    "GET /api/projects/{name}/webhook/shadow-scorecard": ["project webhook shadow-scorecard"],
