// Loads the pure "guardian notice -> toast" logic out of librarian/assets/board.html
...
// ./board-merge-button.mjs -- see those files' headers for why board.html
// can't simply be imported. The region between the RALPHUS-GUARDIAN-NOTICE
...
/** The guardian-notice view logic, evaluated straight from board.html. */
export const guardianNotice = factory();

/** The raw board.html source, for assertions about how the toast is wired up. */
