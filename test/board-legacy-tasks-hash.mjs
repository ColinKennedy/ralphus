...
// check out of the board chunk files (librarian/assets/board/), so RAL-362's legacy-redirect
...
// -- see those files' headers for why the chunk files can't simply be imported.
...
/** The legacy-tasks-hash detection logic, evaluated straight from the board chunks. */
export const legacyTasksHash = factory();

/** The raw board script (all chunks concatenated), for assertions about how `parseHash` dispatches on it. */
