// Loads the Logs modal's "output" button logic out of the board chunk files (librarian/assets/board/)
...
/** `logsOutputBtn`, evaluated straight from the board chunks with a pass-through `esc`. */
