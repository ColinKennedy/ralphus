...
const exported = ["PEEK_MISSING_STRIKE_LIMIT", "peekCssKey", "peekUrlFor", "peekTranscriptUrlFor", "systemPromptUrlFor", "peekPromptDisplay", "peekPromptText", "nextPeekPaneState"];
