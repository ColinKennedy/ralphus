...
// librarian/assets/board.html so it can be exercised under `node --test`
...
// board.html can't simply be imported. The region between the
...
/** The unified debug/terminal-log stream's pure logic, evaluated straight from board.html. */
export const debugStream = factory();

/** The raw board.html source, for assertions about how the stream is wired up. */
