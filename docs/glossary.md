...
| **worktree lease** | Exclusive daemon ownership of one review branch's mutable worktree. Different branch leases may coexist; a stacked rebase owns the whole review and starts only after all branch leases are free. |
