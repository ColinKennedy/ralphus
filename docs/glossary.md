...
| **placeholder** (review) | `ralphus:new-review/<key>` — a review id that mints a *fresh* review per submission. The key groups cells within one submission; it never attaches to a previous submission's review. |
