...
Filed as `tickets/ral-445-remote-worktrees-missing-hook.md`,
`tickets/ral-445-squash-drops-trailers.md`, and
`tickets/ghost-current-revision-local-only.md`. No fixes attempted here —
tickets only.
